...
const Form = ({ signerAddress, setIsLoading, setTrsHash, setErr, networkId, setOpen }) => {
 ...
 const [selectedValue, setSelectedValue] = useState([]);
  ...
  const [surl, setSurl] = useState('');
   const [trait,setTrait_type] =useState('');
  ...
  const onSubmit = async (e) => {
    ...
    if (name && desc && file && selectedValue && signerAddress && (networkId.chainId === 80001 || networkId.chainId === 137)) {
      setIsLoading(true);
      setErr('');
      setTrsHash('');
	...
	attributes:selectedValue      
      ...
      console.log(ipfsHash,"neeelimaaaaa")

      if (nftType === 'ERC721') {
        const web3 = new Web3(window.ethereum)
        const contract_721 = new web3.eth.Contract(abi, "0x386a867B3F17d6aA84A8847677A847333Cc10aaB");
  ...
  return (
    <form className={classes.root} noValidate autoComplete="off" onSubmit={onSubmit}>
      ...
      <div className={classes.formGroup}>
       ...
       <div className={classes.formGroup} >
        <label className={classes.formGroupLabel}>Attributes</label>
