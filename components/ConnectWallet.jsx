...
const ConnectWallet = ({ signerAddress, contract_721, setContract_721, setSignerAddress , setNetworkId}) => {
  ...
  useEffect(() => {
    const getAddress = async () => {
      ...
      setContract_721(new ethers.Contract("0x3C0B1fC821b098F79e54Ea311f3abdcCde55f2d9", abi));
